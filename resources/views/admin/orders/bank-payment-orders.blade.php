...
@section('content')
    ...
    <div class="p-sm-30 p-15">
        ...
        <div class="" id="appendList">
            ...
            <div class="bg-white bd-one bd-c-stroke bd-ra-10 p-sm-30 p-15">
                @include('admin.orders.partial.render-bank-payment-orders-list')
            </div>
        </div>
    </div>
    ...
    <input type="hidden" value="{{ route('admin.order.bank-payment-orders',$status) }}" id="bank-order-route">
@endsection

@push('script')
    <script src="{{ asset('admin/js/custom/bank-payment-order.js') }}"></script>
@endpush
