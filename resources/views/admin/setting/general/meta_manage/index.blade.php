        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                <div class="pb-25 d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <a href="{{ route('admin.setting.meta.add') }}" class="border-0 bg-primary py-8 px-26 bd-ra-8 fs-15 fw-600 lh-25 text-white">
                        <i class="fa fa-plus"></i> {{ __('Add Meta') }}
                    </a>
                </div>
                    ...
                    <table class="table zTable zTable-last-item-right commonDataTable">
                        <thead>
                            <tr>
                                ...
                                <th><div class="text-nowrap">{{ __('Meta Content') }}</div></th>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end g-10">
                                            ...
                                            <button class="d-flex justify-content-center align-items-center w-30 h-30 rounded-circle bd-one bd-c-stroke bg-white deleteItem"
                                                data-formid="delete_row_form_{{ $meta->uuid }}">
                                            ...
                                            <form action="{{ route('admin.setting.meta.delete', [$meta->uuid]) }}"
                                                method="post" id="delete_row_form_{{ $meta->uuid }}">
                                                {{ method_field('DELETE') }}
