<div class="d-flex justify-content-between align-items-center g-10 pb-20 mb-20 bd-b-one bd-c-stroke">
    <h5 class="fs-18 fw-500 lh-28 text-primary-dark-text">{{ __('Preloader') }}</h5>
...
<div class="pb-24">
    <h3 class="fs-16 fw-400 lh-28 text-para-text text-center">{{__('If you enable preloader, the preloader will be show before load the content.')}}</h3>
</div>
<div class="bd-c-stroke bd-t-one d-flex justify-content-center align-items-center pt-15">
    <a class="border-0 bd-ra-12 bg-primary py-13 px-25 fs-16 fw-600 lh-19 text-white" target="_blank"
       href="https://zaistudy-doc.zainikthemes.com">
