<div class="d-flex justify-content-between align-items-center g-10 pb-20 mb-20 bd-b-one bd-c-stroke">
    <h5 class="fs-18 fw-500 lh-28 text-primary-dark-text">{{ __('Google Analytics') }}</h5>
...
<div class="pb-24">
    <h3 class="fs-16 fw-400 lh-28 text-para-text text-center">{{__('If you enable this. The system will enable for google analytics.')}}</h3>
</div>
