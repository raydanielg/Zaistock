        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                <div class="d-flex flex-wrap justify-content-between align-items-center g-10 pb-24">
                    <h2 class="fs-18 fw-600 lh-20 text-primary-dark-text">City</h2>
                ...
                <div class="bg-white bd-one bd-c-stroke bd-ra-10 p-sm-30 p-15">
                    <table class="table zTable zTable-last-item-right commonDataTable">
                        ...
                        <tr>
                            ...
                            <th><div>{{__('State')}}</div></th>
                            <th><div>{{__('Country')}}</div></th>
                            ...
                            <tr class="removable-item">
                                ...
                                <td>
                                    <div class="d-flex justify-content-end align-items-center g-10">
                                        <a href="{{ route('admin.setting.location.city.edit', [$city->id, Str::slug($city->name)]) }}" class="d-flex justify-content-center align-items-center w-30 h-30 rounded-circle bd-one bd-c-stroke bg-white edit" data-toggle="tooltip" title="Edit">
                                        ...
                                        <button class="d-flex justify-content-center align-items-center w-30 h-30 rounded-circle bd-one bd-c-stroke bg-white deleteItem" data-formid="delete_row_form_{{$city->id}}">
                                        ...
                                        <form action="{{ route('admin.setting.location.city.delete', $city->id) }}" method="post" id="delete_row_form_{{ $city->id }}">
                                            {{ method_field('DELETE') }}
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content bd-c-stroke-color bd-ra-12 py-25 px-20">
                <div class="d-flex justify-content-between align-items-center g-10 pb-20 mb-20 bd-b-one bd-c-stroke">
                    <h5 class="fs-18 fw-500 lh-28 text-primary-dark-text">{{ __('Add City') }}</h5>
                ...
                <form action="" method="post">
                    ...
                    <div class="pb-24">
                        <div class="row rg-24">
                            <div class="col-12">
                                    <label class="zForm-label" for="name">{{ __('State name') }}</label>
                            ...
                            <div class="col-12">
                                    ...
                                    <input class="zForm-control" type="text" name="name" id="name" placeholder="Type name" value="{{ old('name') }}" required>
                                    @if ($errors->has('name'))
