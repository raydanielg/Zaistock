...
@section('content')
    ...
    <div class="p-sm-30 p-15">
        ...
        <div class="" id="appendList">
            ...
            <div class="bg-white bd-one bd-c-stroke bd-ra-10 p-sm-30 p-15">
                <table id="contributor-datatable" class="table zTable zTable-last-item-right" >
                    <thead>
                        <tr>
                            <th><div>{{__('SL.')}}</div></th>
    ...
    <input type="hidden" value="{{ route('admin.contributor.index',$status) }}" id="contributor-route">
@endsection

@push('script')
    <script src="{{ asset('admin/js/custom/contributor.js') }}"></script>
@endpush
