    ...
    <div class="p-sm-30 p-15">
        ...
        <div class="bg-white bd-one bd-c-stroke bd-ra-10 p-sm-30 p-15">
            <form action="{{route('admin.coupon.store')}}" method="post" class="form-horizontal">
                ...
                <div class="row rg-24">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" value="{{old('name')}}"
                               placeholder="{{ __('Type coupon name') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="zForm-control" name="use_type" id="use_type" required>
                            <option value="">--{{ __('Select Option') }}--</option>
                            <option value="1">{{ __('Single') }}</option>
                            <option value="2">{{ __('Multiple') }}</option>
                        </select>
                    ...
                    <div class="col-md-6 d-none" id="maximumUseLimitDiv">
                        ...
                        <label class="zForm-label">{{ __('Maximum Use Limit') }}<span
                                class="text-danger">*</span></label>
                        <div class="input-group flex-nowrap">
                            <input type="number" min="1" name="maximum_use_limit" value="{{old('maximum_use_limit')}}"
                                   placeholder="{{ __('Type maximum use limit') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="zForm-control" name="discount_type" id="discount_type" required>
                            <option value="">--{{ __('Select Option') }}--</option>
                            <option value="1">{{ __('Percentage') }}</option>
                            <option value="2">{{ __('Amount') }}</option>
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="zForm-label"><span class="discountValueText"></span><span
                                class="text-danger"> *</span></label>
                        <div class="input-group text-nowrap">
                            <input type="number" min="0" step="any" name="discount_value"
                                   value="{{old('discount_value')}}" placeholder="{{ __('Type discount value') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <label
                            class="zForm-label">{{ __('Minimum Amount Spend to Apply Coupon') . ' ( ' . getCurrencySymbol() . ')'}}
                            <span class="text-danger">*</span></label>
                        <input type="number" min="1" name="minimum_amount" id="minimum_amount"
                               value="{{old('minimum_amount')}}" placeholder="{{ __('Type minimum amount') }}"
                               class="zForm-control" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="start_date" value="{{old('start_date')}}" class="zForm-control"
                               required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="end_date" value="{{old('end_date')}}" class="zForm-control"
                               required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="zForm-control" name="status" id="status">
                            <option value="">--{{ __('Select Option') }}--</option>
                ...
                <div class="d-flex justify-content-end g-10 align-items-center pt-24">
                    <a href="{{route('admin.coupon.index')}}"
                       class="border-0 bg-para-text py-8 px-26 bd-ra-8 fs-15 fw-600 lh-25 text-white d-inline-flex align-items-center g-10"> <i
                            class="fa fa-arrow-left"></i> {{__('Back')}} </a>
                    <button class="border-0 bg-primary py-8 px-26 bd-ra-8 fs-15 fw-600 lh-25 text-white"
