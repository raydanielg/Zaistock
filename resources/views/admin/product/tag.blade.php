...
@section('content')
    ...
    <div class="p-sm-30 p-15">
        <div class="d-flex align-items-center justify-content-between flex-wrap g-15 pb-26">
            <h2 class="fs-24 fw-600 lh-29 text-primary-dark-text">{{ __('Tags') }}</h2>
            <div class="">
        ...
        <div class="bg-white bd-one bd-c-stroke bd-ra-10 p-sm-30 p-15" id="appendList">
            @include('admin.product.partial.render-tag-list')
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content bd-c-stroke-color bd-ra-12 py-25 px-20">
                <div class="d-flex justify-content-between align-items-center g-10 pb-20 mb-20 bd-b-one bd-c-stroke">
                    <h5 class="fs-18 fw-500 lh-28 text-primary-dark-text">{{ __('Add Tag') }}</h5>
                ...
                <form action="{{ route('admin.product.tag.store') }}" method="post" autocomplete="off">
                    @csrf
                    <div class="pb-20">
...
@push('script')
    ...
    <script src="{{ asset('admin/js/custom/product-tag.js') }}"></script>
@endpush
