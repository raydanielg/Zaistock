...
<div class="row rg-24 pb-24">
                            <div class="col-12">
                                ...
                                <textarea name="description" id="summernote" class="summernoteOne">{{ @$policy->description ?? old('description') }}</textarea>
                            ...
                            <div class="d-flex justify-content-end align-items-center g-10 flex-wrap">
