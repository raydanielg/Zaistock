...
@section('content')
    ...
    <div class="p-sm-30 p-15">
        ...
        <div class="" id="appendList">
            ...
            <div class="bg-white bd-one bd-c-stroke bd-ra-10 p-sm-30 p-15">
                <table class="table zTable zTable-last-item-right" id="customer-datatable">
                    <thead>
                        <tr>
                            <th><div>{{__('SL.')}}</div></th>
                            ...
                            <th><div>{{ __('Wallet') }}</div></th>
                            <th><div>{{ __('Available') }}</div></th>
    ...
    <input type="hidden" value="{{ route('admin.customer.index',$status) }}" id="customer-route">
@endsection

@push('script')
    <script src="{{ asset('admin/js/custom/customer.js') }}?v=1"></script>
@endpush
