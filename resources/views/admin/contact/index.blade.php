            ...
            <table class="table zTable zTable-last-item-right commonDataTable">
                <thead>
                    <tr>
                        ...
                        <th><div>{{ __('Topic') }}</div></th>
                        <th><div>{{ __('Message') }}</div></th>
                ...
                @foreach($contactUss as $contact)
                    <tr class="removable-item">
                        ...
                        <td>{{$contact->name}}</td>
                        <td>{{$contact->email}}</td>
                        <td>{{ @$contact->contactUsTopic->name}}</td>
                        ...
                        <td>
                            <div class="d-flex justify-content-end align-items-center g-5">
                                ...
                                <form action="{{ route('admin.contact.delete', $contact->id) }}" method="post" id="delete_row_form_{{ $contact->id }}">
                                    {{ method_field('DELETE') }}
