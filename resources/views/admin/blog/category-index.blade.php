...
@section('content')
    ...
    <div class="p-sm-30 p-15">
        <div class="d-flex align-items-center justify-content-between flex-wrap g-15 pb-26">
            <h2 class="fs-24 fw-600 lh-29 text-primary-dark-text">{{__('Blogs')}}</h2>
            <div class="">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center g-10 pb-24">
            <h2 class="fs-18 fw-600 lh-22 text-primary-dark-text pb-25">{{ __('Blog Category') }}</h2>
            <button class="border-0 bg-primary py-8 px-26 bd-ra-8 fs-15 fw-600 lh-25 text-white d-inline-flex align-items-center g-5" type="button" data-bs-toggle="modal" data-bs-target="#add-todo-modal">
                ...
                @foreach($blogCategories as $category)
                    <tr class="removable-item">
                        ...
                        <td>
                            ...
                            @else
                                <span class="zBadge zBadge-deactivated">{{ __('Deactivated') }}</span>
                            @endif
                        </td>
                        <td>
                            <div class="d-flex justify-content-end align-items-center g-5">
                                <a class="d-flex justify-content-center align-items-center w-30 h-30 rounded-circle bd-one bd-c-stroke bg-white edit" data-item="{{ $category }}" data-updateurl="{{ route('admin.blog.category.update', @$category->uuid) }}"
                                   data-toggle="tooltip"
                                   title="Edit">
                                ...
                                <a href="javascript:void(0);" data-url="{{route('admin.blog.category.delete', [$category->uuid])}}" class="d-flex justify-content-center align-items-center w-30 h-30 rounded-circle bd-one bd-c-stroke bg-white delete" title="Delete">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content bd-c-stroke-color bd-ra-12 py-25 px-20">
                <div class="d-flex justify-content-between align-items-center g-10 pb-20 mb-20 bd-b-one bd-c-stroke">
                    <h5 class="fs-18 fw-500 lh-28 text-primary-dark-text">{{ __('Add Blog Category') }}</h5>
                    ...
                    <div class="pb-24">
                        <div class="row rg-24">
                            <div class="col-12">
                                ...
                                <input class="zForm-control" type="text" name="name" id="name" placeholder="Type name" value="" required>
                                @if ($errors->has('name'))
    ...
    <div class="modal fade edit_modal" id="add-todo-modal" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content bd-c-stroke-color bd-ra-12 py-25 px-20">
                <div class="d-flex justify-content-between align-items-center g-10 pb-20 mb-20 bd-b-one bd-c-stroke">
                    <h5 class="fs-18 fw-500 lh-28 text-primary-dark-text">{{ __('Edit Blog Category') }}</h5>
                    <button type="button" class="w-30 h-30 rounded-circle d-flex justify-content-center align-items-center bd-one bd-c-stroke-color bg-transparent" data-bs-dismiss="modal" aria-label="Close"><i class="fa-solid fa-times"></i></button>
                </div>
...
@push('script')
    <script src="{{ asset('admin/js/custom/blog-category.js') }}"></script>
@endpush
